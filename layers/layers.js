...
lyr_Arabic_Countries_0.set('fieldLabels', {'FIPS_CNTRY': 'inline label', 'GMI_CNTRY': 'inline label', 'CNTRY_NAME': 'inline label', 'SOVEREIGN': 'no label', 'POP_CNTRY': 'inline label', 'SQKM_CNTRY': 'no label', 'SQMI_CNTRY': 'no label', 'CURR_TYPE': 'no label', 'CURR_CODE': 'no label', 'LANDLOCKED': 'no label', 'COLOR_MAP': 'no label', 'Mame_AR': 'no label', });
